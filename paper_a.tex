...
high-PM$_{10}$ events, against 89--91\% for LightGBM.
...
\caption{Diagnostic complements for horizon-wise interpretation.
  ...
  \textit{Right}: reported across-horizon ranges for exceedance recall and
  precision at the P75 threshold under fold-recalibrated evaluation; SARIMA
  recall was reported approximately.}
