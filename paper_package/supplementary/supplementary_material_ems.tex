% Supplementary material for the multi-station PM10 decision audit.

\subsection*{S1. Reporting-audit context}
\input{tables/prisma_reporting_audit_summary.tex}

\begin{figure}[t]
\centering
\includegraphics[width=0.92\linewidth]{figures/figure1_reporting_gap_audit.pdf}
...
\caption{Monitoring stations included in the study. Stations span industrial,
  ...
  observations represented in the recovered station metadata.}
