...
\textbf{Model evaluation specification.} Reconstructed from the frozen evidence and repository configuration. ``Not recoverable'' denotes a detail not established by the canonical provenance; it is not inferred from model names.\par\smallskip
