...
an expanding-window rolling-origin evaluation over January--July 2023.
Forecasts are issued once per day for horizons from 1 to 24 hours. Persistence
...
still less straightforward across Ireland. Five of the eight stations already
reach the 24-hour evaluation boundary with the lags-only model, leaving little
observable room for the strict horizon to extend further. These results make
