...
- **Verdict:** `P3_08_READY_FOR_AUTHOR_REVIEW`
...
4. **Declarations & Statements:** Included CRediT Author Statement, Declaration of Competing Interest, Data & Code Availability Statements, and an explicit no-grant Funding Statement in both the manuscript and as standalone submission text files.
